...
let
  ...
  pkgs-old =
    import
      ...
      {
        system = stdenv.currentSystem;
      };
  openjfx11 = pkgs-old.openjfx11.override { withWebKit = true; };
in
stdenv.mkDerivation rec {
  ...
  buildPhase = ''
    ...
    jar -uf opt/microsoft/identity-broker/lib/javafx-graphics-15-linux.jar -C ${openjfx11}/modules_libs/javafx.graphics/ libglassgtk3.so
    jar -uf opt/microsoft/identity-broker/lib/javafx-graphics-15-linux.jar -C ${openjfx11}/modules_libs/javafx.graphics/ libprism_es2.so
