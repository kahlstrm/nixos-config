# yoinked from https://github.com/NixOS/nixpkgs/blob/a4edf434408665a625fc6ab99c1d8668e741759c/pkgs/development/compilers/openjdk/openjfx/11/default.nix
{
  stdenv,
  lib,
  pkgs,
...
stdenv.mkDerivation {
  ...
  preBuild = ''
    ...
    export NIX_CFLAGS_COMPILE="$(pkg-config --cflags glib-2.0) $NIX_CFLAGS_COMPILE -Wno-error=int-conversion -Wno-error=dangling-pointer -Wno-error=incompatible-pointer-types"
  '';
